...
def read_xml(fname, fpath):
    def parse_line(str_content):
        ...
        content_list = str_content.split('_FONTS_')
        str_content = "\n<fonts>\n".join(content_list)

        
        content_list = str_content.split('_BLUE_')
        str_content = "\n<blue>\n".join(content_list)
        content_list = str_content.split('_RED_')
        str_content = "\n<red>\n".join(content_list)
        content_list = str_content.split('_FONTE_')
        str_content = "\n</font>\n".join(content_list)
        ...
        str_content = "\n&ge;\n".join(content_list)
        content_list = str_content.split('_AND_')
        str_content = "\n&and;\n".join(content_list)
        # 4 * &nbsp; (or a single &emsp;
    ...
    #hint_content = root.find('hint')
    
    if question_type is None or (int(question_type) != 1  and  int(question_type) != 5 ) :
        question_type = 0
